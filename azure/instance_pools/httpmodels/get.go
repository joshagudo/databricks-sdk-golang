...
type GetResp struct {
	...
	DiskSpec                           instancepoolsModels.DiskSpec           `json:"disk_spec,omitempty" url:"disk_spec,omitempty"`
	...
	State                              instancepoolsModels.InstancePoolState  `json:"state,omitempty" url:"state,omitempty"`
	Stats                              instancepoolsModels.InstancePoolStats  `json:"stats,omitempty" url:"stats,omitempty"`
	Status                             instancepoolsModels.InstancePoolStatus `json:"status,omitempty" url:"status,omitempty"`
}
